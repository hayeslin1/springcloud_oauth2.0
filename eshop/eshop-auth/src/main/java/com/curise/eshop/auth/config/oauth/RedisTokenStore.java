...
public class RedisTokenStore implements TokenStore {
    ...
    public OAuth2AccessToken getAccessToken(OAuth2Authentication authentication) {
        log.error("RedisTokenStore.OAuth2AccessToken.OAuth2Authentication.authentication");
    ...
    public void storeAccessToken(OAuth2AccessToken token, OAuth2Authentication authentication) {
        log.error("RedisTokenStore.storeAccessToken.OAuth2AccessToken.token.OAuth2Authentication.authentication");
    ...
    public OAuth2AccessToken readAccessToken(String tokenValue) {
        log.error("RedistokenStore.readAccessToken");
    ...
    public void removeAccessToken(String tokenValue) {
        log.error("RedistokenStore.removeAccessToken");
    ...
    public void storeRefreshToken(OAuth2RefreshToken refreshToken, OAuth2Authentication authentication) {
        log.error("RedistokenStore.storeRefreshToken");
    ...
    public OAuth2RefreshToken readRefreshToken(String tokenValue) {
        log.error("RedistokenStore.readRefreshToken");
    ...
    public void removeRefreshToken(String tokenValue) {
        log.error("RedistokenStore.removeRefreshToken");
    ...
    private void removeAccessTokenUsingRefreshToken(String refreshToken) {
        log.error("RedistokenStore.removeAccessTokenUsingRefreshToken");
    ...
    public Collection<OAuth2AccessToken> findTokensByClientIdAndUserName(String clientId, String userName) {
        log.error("RedistokenStore.findTokensByClientIdAndUserName");
    ...
    public Collection<OAuth2AccessToken> findTokensByClientId(String clientId) {
        log.error("RedistokenStore.findTokensByClientId");
